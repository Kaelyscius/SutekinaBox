 ...
 */
final class Version20180711152725 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE sutekina_box (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(80) NOT NULL, budget DOUBLE PRECISION NOT NULL, products LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', creation_date DATETIME NOT NULL, state LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sutekina_box_product (sutekina_box_id INT NOT NULL, product_id INT NOT NULL, INDEX IDX_40649AF6E2DE407 (sutekina_box_id), INDEX IDX_40649AF64584665A (product_id), PRIMARY KEY(sutekina_box_id, product_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, message_recived_id INT DEFAULT NULL, firstname VARCHAR(60) NOT NULL, lastname VARCHAR(80) NOT NULL, email VARCHAR(100) NOT NULL, password VARCHAR(64) NOT NULL, registration_date DATETIME NOT NULL, last_connexion_date DATETIME DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_8D93D64929B5115E (message_recived_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE sutekina_box_product ADD CONSTRAINT FK_40649AF6E2DE407 FOREIGN KEY (sutekina_box_id) REFERENCES sutekina_box (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE sutekina_box_product ADD CONSTRAINT FK_40649AF64584665A FOREIGN KEY (product_id) REFERENCES product (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sutekina_box_product DROP FOREIGN KEY FK_40649AF64584665A');
        $this->addSql('ALTER TABLE product DROP FOREIGN KEY FK_D34A04ADA65F9C7D');
        $this->addSql('ALTER TABLE sutekina_box_product DROP FOREIGN KEY FK_40649AF6E2DE407');
        ...
        $this->addSql('DROP TABLE sutekina_box_product');
